...
void inference(){
    ...
    TRTLogger logger;
    auto engine_data = load_file("/home/yao/workspace/learn_tensorRT/08_module_depoly/01_memory/workspace/classifier.trt");
    ...
    ///////////////////////////////////////////////////
    // image to float
    auto image = cv::imread("/home/yao/workspace/learn_tensorRT/08_module_depoly/02_tensor/workspace/dog.jpg");
    ...
    auto labels = load_labels("/home/yao/workspace/learn_tensorRT/08_module_depoly/02_tensor/workspace/labels.imagenet.txt");
