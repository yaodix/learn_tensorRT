...
void inference(){
    ...
    ///////////////////////////////////////////////////
    // image to float
    auto image = cv::imread("/home/yao/workspace/learn_tensorRT/08_module_depoly/01_memory/workspace/dog.jpg");
    ...
    auto labels = load_labels("/home/yao/workspace/learn_tensorRT/08_module_depoly/01_memory/workspace/labels.imagenet.txt");
