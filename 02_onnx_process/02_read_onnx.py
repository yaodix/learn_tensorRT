...
model = onnx.load("./02_onnx_process/workspace/demo.onnx")
...
# print(conv_weight.dims[1])  # 1

# 数据是以protobuf的格式存储的，因此当中的数值会以bytes的类型保存，
# 通过np.frombuffer方法还原成类型为float32的ndarray
