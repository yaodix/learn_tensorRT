...
void inference(){
    ...
    ///////////////////////////////////////////////////
    // letter box
    auto image = cv::imread("/home/yao/workspace/learn_tensorRT/06_yolov5_deploy/01_yolov5s/workspace/car.jpg");
    // 通过双线性插值对图像进行resize
    ...
    cv::imwrite("/home/yao/workspace/learn_tensorRT/06_yolov5_deploy/01_yolov5s/workspace/input-image.jpg", input_image);
    ...
    cv::imwrite("/home/yao/workspace/learn_tensorRT/06_yolov5_deploy/01_yolov5s/workspace/image-draw.jpg", image);
