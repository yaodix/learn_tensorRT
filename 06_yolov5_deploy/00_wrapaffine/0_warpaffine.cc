...
int main(){ 
    ...
    Mat image = imread("/home/yao/workspace/learn_tensorRT/06_yolov5_deploy/workspace/yq.jpg");
    std::cout << image.empty() << std::endl;
    Mat output = warpaffine_to_center_align(image, Size(640, 640));
    imwrite("/home/yao/workspace/learn_tensorRT/06_yolov5_deploy/workspace/output.jpg", output);
