...
int main(){
    ...
    host_page_locked_memory[1] = 123;
    printf("host_page_locked_memory[0] = %f\n", host_page_locked_memory[1]);
    /* 
        记住这一点
    ...
    float new_value = 555;
    checkDriver(cuMemsetD32((CUdeviceptr)host_page_locked_memory+4, *(unsigned int*)&new_value, 1)); //??? cuMemset用来干嘛？
